...
# Appended to the supplied ASC table in asc_h-sumbasic-0.1.0a16.py so no
...
GRAPHICS_STUBS = {
    ...
    "DISPLAY", "SHOW", "RECTANGLE", "POLYGON", "ELLIPSE", "COLOR", "PAINT", "FILL", "CHART", "TABLE",
    "PUT", "BSAVE", "BLOAD", "POKE",
    "CREATE-SCR", "SELECT-SCR", "WRITE-SCR", "REPRESENT-SCR",
};
